...
const Testimonials = () => (
  ...
  >
    ...
    <div
      className="relative z-[1] mb-6 flex w-full flex-col items-center justify-between 
    sm:mb-16 md:flex-row"
    >
    ...
    <div
      className="feedback-container relative z-[1] flex w-full flex-wrap 
